    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-teal-950/70 via-slate-900 to-cyan-950/70 border border-teal-800/40 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-300 max-w-xl">
            Academic faculty ranks, tenure governance, leave administration, monthly payroll computation, and compliance.
          </p>
        </div>
      ...
      {activeNavTab === 'data_lifecycle' && (
        <PortalDataLifecycleManager
          ...
          title="HR Staff Directory & Contract Lifecycle Governance"
          subtitle="Governed appointment records, promotion drafts, tenure confirmations, contract renewals, and staff departures."
        />
      )}
