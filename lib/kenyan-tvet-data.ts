...
export const KENYAN_PUBLIC_PROGRAMMES: PublicProgrammeItem[] = [
  ...
  },
  {
    id: 'prog_cyber_13',
    code: 'CDACC-CYB-06',
    name: 'Diploma in Cybersecurity & Digital Forensics (CBET Level 6)',
    departmentId: 'dept_computing',
    departmentName: 'Department of Computing & Informatics',
    facultyName: 'School of Applied Sciences & Technology',
    qualificationLevel: 'DIPLOMA',
    ...
    durationTerms: 9,
    studyMode: 'FULL_TIME',
    campus: 'Nairobi Main Campus ICT Labs',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade C- (Minus) with passes in Mathematics and English, or Level 5 Certificate in ICT.',
    kcseRequirement: 'KCSE C- (Minus)',
    tuitionFeePerTerm: 21000,
    totalEstimatedFee: 189000,
    careerOutcomes: [
      'SOC Security Analyst (Tier 1 & 2)',
      'Vulnerability Assessment & Pen-Tester',
      'Digital Forensics Investigator',
      'Information Security Compliance Officer'
    ],
    accreditation: 'TVET CDACC Certified • National Cyber Command Curriculum',
    featured: true
  },
  {
    id: 'prog_mech_plant_14',
    code: 'DME-PLT-01',
    name: 'Diploma in Mechanical Engineering (Plant & Production Option)',
    departmentId: 'dept_mechanical',
    departmentName: 'Department of Mechanical & Automotive Engineering',
    facultyName: 'School of Engineering & Built Environment',
    qualificationLevel: 'DIPLOMA',
    ...
    durationTerms: 9,
    studyMode: 'FULL_TIME',
    campus: 'Nairobi Main Campus Heavy Plant Workshop',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade C- (Minus) with C- in Mathematics and Physics.',
    kcseRequirement: 'KCSE C- with Physics',
    tuitionFeePerTerm: 22500,
    totalEstimatedFee: 202500,
    careerOutcomes: [
      'Industrial Plant Maintenance Supervisor',
      'Boiler & Steam Turbine Operator',
      'CNC Machining & Milling Specialist',
      'Manufacturing Quality Controller'
    ],
    accreditation: 'KNEC Approved • Certified by Engineers Board of Kenya (EBK) TVET Registry',
    featured: false
  },
  {
    id: 'prog_weld_fab_15',
    code: 'CDACC-WLD-06',
    name: 'Diploma in Welding & Fabrication Technology (CBET Level 6)',
    departmentId: 'dept_mechanical',
    departmentName: 'Department of Mechanical & Automotive Engineering',
    facultyName: 'School of Engineering & Built Environment',
    qualificationLevel: 'DIPLOMA',
    ...
    campus: 'Nairobi Main Campus & Nakuru',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade C- (Minus) or Craft Certificate in Welding & Fabrication.',
    kcseRequirement: 'KCSE C- (Minus)',
    tuitionFeePerTerm: 21500,
    totalEstimatedFee: 193500,
    careerOutcomes: [
      'Underwater & Pipeline Coded Welder (TIG/MIG)',
      'Structural Steel Fabricator & Inspector',
      'Pressure Vessel Testing Inspector',
      'Oil, Gas & Energy Facility Welder'
    ],
    accreditation: 'TVET CDACC Certified • International Welder Standard Compliant',
    featured: true
  },
  {
    id: 'prog_plumb_16',
    code: 'CPL-02',
    name: 'Craft Certificate in Plumbing & Building Services',
    departmentId: 'dept_civil',
    departmentName: 'Department of Building & Civil Engineering',
    facultyName: 'School of Engineering & Built Environment',
    qualificationLevel: 'CRAFT_CERTIFICATE',
    ...
    durationTerms: 6,
    studyMode: 'FULL_TIME',
    campus: 'All Campuses (Nairobi, Nakuru)',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade D (Plain) or Artisan Certificate in Plumbing.',
    kcseRequirement: 'KCSE D (Plain)',
    tuitionFeePerTerm: 16500,
    totalEstimatedFee: 99000,
    careerOutcomes: [
      'Commercial Pipefitter & Plumbing Contractor',
      'Water Supply & Drainage Systems Installer',
      'Solar Water Heating Technician',
      'Fire Fighting Pipework Specialist'
    ],
    accreditation: 'KNEC Approved • National Construction Authority (NCA) Recognized',
    featured: false
  },
  {
    id: 'prog_supply_chain_17',
    code: 'DSCM-01',
    name: 'Diploma in Supply Chain Management & Procurement',
    departmentId: 'dept_business',
    departmentName: 'Department of Business & Management Studies',
    facultyName: 'School of Business & Social Sciences',
    qualificationLevel: 'DIPLOMA',
    ...
    durationTerms: 9,
    studyMode: 'FULL_TIME',
    campus: 'All Campuses & CBD Town Campus',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade C- (Minus) with D+ in English/Kiswahili and Mathematics.',
    kcseRequirement: 'KCSE C- (Minus)',
    tuitionFeePerTerm: 17500,
    totalEstimatedFee: 157500,
    careerOutcomes: [
      'Procurement & Purchasing Officer',
      'Warehouse & Inventory Controller',
      'Logistics & Freight Forwarding Agent',
      'Public Procurement & Disposal Analyst (PPRA)'
    ],
    accreditation: 'KNEC Approved • KISM (Kenya Institute of Supplies Management) Member Institution',
    featured: false
  },
  {
    id: 'prog_cert_fb_18',
    code: 'CFB-02',
    name: 'Craft Certificate in Food & Beverage Production & Service',
    departmentId: 'dept_hospitality',
    departmentName: 'Department of Hospitality & Tourism Management',
    facultyName: 'School of Hospitality, Cosmetology & Human Ecology',
    qualificationLevel: 'CRAFT_CERTIFICATE',
    ...
    durationTerms: 6,
    studyMode: 'FULL_TIME',
    campus: 'Nairobi Main Campus Culinary Wing',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade D (Plain) or Artisan Certificate in Food and Beverage.',
    kcseRequirement: 'KCSE D (Plain)',
    tuitionFeePerTerm: 19000,
    totalEstimatedFee: 114000,
    careerOutcomes: [
      'Pastry & Bakery Chef',
      'Restaurant Bartender & Barista',
      'Hospitality Banqueting Attendant',
      'Institutional Caterer'
    ],
    accreditation: 'KNEC Approved • Tourism Regulatory Authority (TRA) Certified',
    featured: false
  },
  {
    id: 'prog_beauty_19',
    code: 'HBT-03',
    name: 'Certificate in Hairdressing, Beauty Therapy & Cosmetology',
    departmentId: 'dept_hospitality',
    departmentName: 'Department of Hospitality & Tourism Management',
    facultyName: 'School of Hospitality, Cosmetology & Human Ecology',
    qualificationLevel: 'CERTIFICATE',
    ...
    durationTerms: 5,
    studyMode: 'FULL_TIME',
    campus: 'CBD Town Campus & Nairobi Main',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade D- (Minus) or KCPE Certificate.',
    kcseRequirement: 'KCSE D- / KCPE',
    tuitionFeePerTerm: 15500,
    totalEstimatedFee: 77500,
    careerOutcomes: [
      'Professional Cosmetologist & Aesthetician',
      'Bridal Makeup & Hair Stylist',
      'Salon & Spa Salon Director',
      'Dermatological Beauty Consultant'
    ],
    accreditation: 'NITA Certified Grade I, II, III Assessments',
    featured: false
  },
  {
    id: 'prog_banking_fin_20',
    code: 'DBF-01',
    name: 'Diploma in Banking, Microfinance & Financial Technology',
    departmentId: 'dept_business',
    departmentName: 'Department of Business & Management Studies',
    facultyName: 'School of Business & Social Sciences',
    qualificationLevel: 'DIPLOMA',
    ...
    durationTerms: 9,
    studyMode: 'FULL_TIME',
    campus: 'CBD Town Campus & Main Campus',
    intakes: ['JANUARY', 'MAY', 'SEPTEMBER'],
    minimumRequirements: 'KCSE Mean Grade C- (Minus) with C- in Mathematics and English.',
    kcseRequirement: 'KCSE C- (Minus)',
    tuitionFeePerTerm: 18000,
    totalEstimatedFee: 162000,
    careerOutcomes: [
      'Bank Credit & Loan Officer',
      'SACCO Operations Supervisor',
      'Microfinance Credit Assessor',
      'Fintech Customer Onboarding Specialist'
    ],
    accreditation: 'KNEC Approved • Kenya Institute of Bankers (KIB) Recognized',
    featured: false
  }
];
